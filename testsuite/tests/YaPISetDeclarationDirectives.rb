...
module Yast
  class YaPISetDeclarationDirectivesClient < Client
    def main
      ...
      DUMP("==========================================================")
      TEST(lambda do
        YaPI::DHCPD.SetDeclarationDirectives(
          {},
          "subnet",
          "192.168.0.0 netmask 255.255.255.0",
          [
            { "key" => "max-lease-time", "value" => "123456" },
            { "value" => "192.168.0.110 192.168.0.220", "key" => "range" }
          ]
        )
      end, [
        @READ,
...
Yast::YaPISetDeclarationDirectivesClient.new.main
