...
module Yast
  class YaPIGetDeclarationDirectivesClient < Client
    def main
      ...
      DUMP("==========================================================")
      TEST(lambda do
        YaPI::DHCPD.GetDeclarationDirectives(
          {},
          "subnet",
      ...
      DUMP("==========================================================")
      TEST(lambda { YaPI::DHCPD.GetDeclarationDirectives({}, "", "") }, [
        @READ,
        @WRITE,
        @EXEC
      ], nil)
...
Yast::YaPIGetDeclarationDirectivesClient.new.main
