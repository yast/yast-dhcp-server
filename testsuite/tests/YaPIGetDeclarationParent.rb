...
module Yast
  class YaPIGetDeclarationParentClient < Client
    def main
      ...
      DUMP("==========================================================")
      TEST(lambda do
        YaPI::DHCPD.GetDeclarationParent(
          {},
          "subnet",
      ...
      DUMP("==========================================================")
      TEST(lambda { YaPI::DHCPD.GetDeclarationParent({}, "host", "h1") }, [
        @READ,
        @WRITE,
        @EXEC
      ], nil)
...
Yast::YaPIGetDeclarationParentClient.new.main
