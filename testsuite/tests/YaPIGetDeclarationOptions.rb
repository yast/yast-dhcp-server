...
module Yast
  class YaPIGetDeclarationOptionsClient < Client
    def main
      ...
      DUMP("==========================================================")
      TEST(lambda do
        YaPI::DHCPD.GetDeclarationOptions(
          {},
          "subnet",
      ...
      DUMP("==========================================================")
      TEST(lambda { YaPI::DHCPD.GetDeclarationOptions({}, "", "") }, [
        @READ,
        @WRITE,
        @EXEC
      ], nil)
...
Yast::YaPIGetDeclarationOptionsClient.new.main
