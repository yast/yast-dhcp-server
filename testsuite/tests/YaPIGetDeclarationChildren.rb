...
module Yast
  class YaPIGetDeclarationChildrenClient < Client
    def main
      ...
      DUMP("==========================================================")
      TEST(lambda { YaPI::DHCPD.GetChildrenOfDeclaration({}, "", "") }, [
        @READ,
        @WRITE,
        @EXEC
      ], nil)
      DUMP("==========================================================")
      TEST(lambda do
        YaPI::DHCPD.GetChildrenOfDeclaration(
          {},
          "subnet",
      ...
      DUMP("==========================================================")
      TEST(lambda { YaPI::DHCPD.GetChildrenOfDeclaration({}, "host", "h1") }, [
        @READ,
        @WRITE,
        @EXEC
      ], nil)
...
Yast::YaPIGetDeclarationChildrenClient.new.main
